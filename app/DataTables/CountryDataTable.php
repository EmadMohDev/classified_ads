...
class CountryDataTable extends DataTable
{
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->pageLength(5)
                    ->buttons([
                        Button::make()->text('<i class="fa fa-plus"></i> <span class="hidden" data-yajra-href="'.routeHelper('countries.create').'"></span>')->addClass('btn btn-info show-modal-form '. (canUser("countries-create") ? "" : "remove-hidden-element"))->titleAttr(trans('menu.create-row', ['model' => trans('menu.aggregator')])),
                        Button::make()->text('<i class="fas fa-trash"></i>')->addClass('btn btn-danger multi-delete '. (canUser("countries-multidelete") ? "" : "remove-hidden-element"))->titleAttr(trans('buttons.multi-delete')),
