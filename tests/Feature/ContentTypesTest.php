...
class ContentTypesTest extends TestCase
{
    ...
    {
        $data = ['name' => 'Content Type', 'visible_to_content' => 1];
    ...
    {
        $row = $this->model::where('name', 'Content Type')->first();
    ...
    {
        $row = $this->model::where('name', 'Content Type')->first();
        $data = ['name' => 'Edit Content Type', 'visible_to_content' => (int) !$row->active];
    ...
    {
        $row = $this->model::where('name', 'Edit Content Type')->first();
