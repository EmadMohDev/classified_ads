...
class OperatorsTest extends TestCase
{
    ...
    {
        $data = [
            'name' => ['ar' => 'Operator ar', 'en' => 'Operator en'],
    ...
    {
        $row = $this->model::where('name->ar', 'LIKE', '%Operator ar%')->first();
    ...
    public function test_update_row()
    {
        $row = $this->model::where('name->ar', 'LIKE', '%Operator ar%')->first();
        $data = [
            "name"      => ['ar' => 'Edit Operator ar', 'en' => 'Edit Operator en'],
            'country_id' => Country::first()->id
        ];
    ...
    {
        $row = $this->model::where('name->ar', 'LIKE', '%Edit Operator ar%')->first();
