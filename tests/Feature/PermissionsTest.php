...
class PermissionsTest extends TestCase
{
    ...
    {
        $row = $this->model::where('name', 'test_permissions')->first();
    ...
    {
        $row = $this->model::where('name', 'test_permissions')->first();
        $data = ['name' => 'new_test_permissions'];
    ...
    {
        $row = $this->model::where('name', 'new_test_permissions')->first();
